...
async function generateImage(templateData, outputFilename, bgFileName, width = 1920, height = 1080, layout = { top: 80, left: 0, align: 'center', maxW: 100 }, templateFileName = 'poster-template.html') {
    ...
    try {
        ...
        const finalHtml = template({
            ...
            hide_yubit_logo: layout.hideYubitLogo || false,
            ...
            vip_width: layout.vipWidth || 468,
            vip_height: layout.vipHeight || 65,
            vip_font_size: layout.vipFontSize || 30,
            vip_font_weight: layout.vipFontWeight || 700,
            vip_diamond_width: layout.vipDiamondWidth || 48,
